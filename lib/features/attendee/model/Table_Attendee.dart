class Table_Attendee {
  ...
  Table_Attendee({
    ...
    required this.fldPancard,
    required this.fldDob,
    required this.fldAge,
    required this.fldQualification,
    required this.fldMobile,
    required this.fldGiftGiven,
    required this.fldContractor,
    required this.fldContractorSites,
    required this.fldContractorTeamSize,
    required this.fldSmartphone,
    required this.fldAppDownloadNebula,
    required this.fldAppDownloadAttendee,
    required this.fldNotDownloadReason,
    required this.fldAdhesiveBrand,
    required this.fldAdhesiveConsumption,
    required this.fldAttendance,
    required this.fldOrderValue,
    required this.fldOrderPlaced,
    required this.fldOrderDetails,
    required this.fldCompetitionPoints,
    required this.fldRef1,
    required this.fldRef2,
    required this.fldRef3,
    required this.fldRemark1,
    required this.fldRemark2,
