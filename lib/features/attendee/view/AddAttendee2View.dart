  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      return Scaffold(
          ...
          body: SafeArea(
            child: controller.isLoading == true ? CustomLoaderWidget(color: AppColors.primaryColor,) : SingleChildScrollView(keyboardDismissBehavior: ScrollViewKeyboardDismissBehavior.manual,
