...
class AddAttendee3Controller extends GetxController {
  ...
  void onInit() {
    ...
    if (arguments != null) {
      ...
      if (arguments['Attendees'] != null) {
        ...
        if(data.fldDealerId.isNotEmpty && dealers.any((dealer) => dealer.fldDrid == int.tryParse(data.fldDealerId))) {
  ...
  validateAndProcess() async {
    ...
    // }
      ...
      AppUtils.showSnackbar(Get.context!,"Please enter number of Site", "Info");
