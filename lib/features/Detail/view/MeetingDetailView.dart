...
import 'package:birlacable/features/Detail/controller/MeetingDetailController.dart';
   ...
   // controller.onInit();
    return Obx(() {
      return Scaffold(
          ...
          body: SafeArea(
            child: controller.isLoading == true ? CustomLoaderWidget(color: AppColors.primaryColor,) : SingleChildScrollView(keyboardDismissBehavior: ScrollViewKeyboardDismissBehavior.onDrag,
